...
from app.benchmarks import llm
...
def test_build_provider_minimax_raises_when_any_field_is_missing():
    llm_config = config.LLMConfig(provider_name="minimax", minimax_api_key="mm-secreta")
...
def test_build_provider_raises_for_an_unknown_provider():
    llm_config = config.LLMConfig(provider_name="anthropic")
